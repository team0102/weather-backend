...
let CityRepository = class CityRepository {
    constructor(cityTypeormRepository) {
        this.cityTypeormRepository = cityTypeormRepository;
    }
    async findCityByCityId(cityId) {
...
exports.CityRepository = CityRepository = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(cities_entity_1.CityEntity)),
