...
let FeedCommentRepository = class FeedCommentRepository {
    ...
    async createFeedComment(userId, feedId, content) {
    ...
    async updateFeedComment(commentId, content) {
        await this.feedCommentRepository.update({ id: commentId }, { content: content });
    }
};
exports.FeedCommentRepository = FeedCommentRepository;
exports.FeedCommentRepository = FeedCommentRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(feedComments_entity_1.FeedCommentEntity)),
